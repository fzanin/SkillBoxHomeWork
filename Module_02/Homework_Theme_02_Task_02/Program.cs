...
namespace Homework_Theme_02_Task_02
{
    class Program
    {
        /// <summary>
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Worker {0} has average score equal {1:0.00}", worker01.FirstName, worker01.ScoreAverage);
            ...
            Console.WriteLine("Worker {0} has average score equal {1:F2}", worker02.FirstName, worker02.ScoreAverage);
            Console.ReadKey();  // wait for press any key
            ...
            Console.WriteLine("Worker {0} has average score equal {1:F2}", worker03.FirstName, worker03.ScoreAverage);
            Console.ReadKey();  // wait for press any key
